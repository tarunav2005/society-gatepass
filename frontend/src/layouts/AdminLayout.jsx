...
const navItems = [
  ...
  { to: "/admin/categories", icon: Tags, label: "Visitor Categories" },
  { to: "/admin/staff", icon: UserCog, label: "Staff / Maids" },
  { to: "/admin/blacklist", icon: ShieldAlert, label: "Blacklist" },
  { to: "/admin/history", icon: History, label: "Visitor History" },
  { to: "/admin/broadcast", icon: Megaphone, label: "Emergency Broadcast" },
  { to: "/admin/approvals", icon: UserCheck, label: "Pending Approvals" },
...
// Inline (non-fixed) version of theme toggle for header bar
