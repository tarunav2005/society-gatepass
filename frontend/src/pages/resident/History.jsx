      ...
      render: (r) => (
        <div className="flex items-center gap-3">
          {r.status === "approved" && (
            <button
              onClick={() =>
                setQrModal({ visitorId: r._id, visitorName: r.name })
              }
          ...
          {r.status === "checked_in" && (
            ...
            >
              {processingId === r._id ? "Checking out..." : "Check Out"}
            </button>
          )}
        </div>
      ),
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="All visitor requests for your flat"
      />
      <DataTable columns={columns} data={visitors} loading={loading} />
      <QRModal
        open={!!qrModal}
